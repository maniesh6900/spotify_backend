 ...
 */
export async function uploadMp3ToS3(fileBuffer, originalFilename, bucketName, customKey) {
    // Validate MP3 file
 ...
 */
export async function uploadMp3StreamToS3(fileStream, filename, bucketName, customKey) {
    const key = customKey
        ? `${customKey}.mp3`
        : `${randomUUID()}.mp3`;
    const uploadParams = {
