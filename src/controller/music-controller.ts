...
export const addMusic = asyncHandler(  async (req : any, res) => {
    ...
    const audioFile: Express.Multer.File = audio[0]!;
    ...
    const {url} = await uploadMp3ToS3(buffer, audioFile.filename , process.env.AWS_BUCKET as string);
